...
export class QuestionService {
  ...
  currentAccumulatedPrize: number = 0;
  ...
  // importante para tocar os áudios
  private readonly questionPrizes = [
    1000,
    2000,
    3000,
    4000,
  ...
  getPrizeInfo() {
    const curQuestionPrize: number = this.questionPrizes[ this.questionCount - 1 ];
    const accumulated: number = this.questionPrizes[ this.questionCount - 2 ];
    return {
